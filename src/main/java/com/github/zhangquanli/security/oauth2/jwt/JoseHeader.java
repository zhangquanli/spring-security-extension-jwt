 ...
 * whether the JWT is a JWS or JWE, that describe the cryptographic operation applied to the JWT
...
public final class JoseHeader {
    ...
    public static final class Builder {
        ...
        /**
         * Sets the key ID that is a hit indicating which key was used to secure the JWS or JWE.
         *
         ...
         * or certificate chain corresponding to the key used to digitally sign the JWS or encrypt the JWE.
         *
         * @param x509CertificateChain the X.509 ceritficate chain
         * @return the {@link Builder}
         */
        ...
        /**
         * Sets the critical headers that indicates which extensions to the JWS/JWE/JWA specification
         * are being used that MUST be understood and processed.
         *
        ...
        private void convertAsURL(String header) {
            ...
            if (value != null) {
                ...
                headers.put(header, convertedValue);
            }
        }
    }
}
